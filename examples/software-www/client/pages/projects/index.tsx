...
function StatusBadge({ status }: { status: ProjectStatus }): JSX.Element {
  if (status === "production") {
    return (
      <span class="inline-flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-widest text-primary font-bold bg-primary/25 border border-primary/40 px-2 py-0.5 rounded">
  ...
  if (status === "development") {
    return (
      <span class="inline-flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-widest text-info font-bold bg-info/25 border border-info/40 px-2 py-0.5 rounded">
        <span class="relative flex h-1.5 w-1.5">
  ...
  return (
    <span class="inline-flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-widest text-success font-bold bg-success/25 border border-success/40 px-2 py-0.5 rounded">
      <svg
        class="w-2.5 h-2.5"
        viewBox="0 0 20 20"
        fill="currentColor"

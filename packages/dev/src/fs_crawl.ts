import { type FsAdapter, fsAdapter } from "../../core/src/fs.ts";
import type { WalkEntry } from "@std/fs/walk";
import type { FsRouteFileNoMod } from "./dev_build_cache.ts";
import * as path from "@std/path";
import { pathToPattern } from "../../core/src/router.ts";
import { CommandType } from "../../core/src/commands.ts";
import { sortRoutePaths } from "../../core/src/fs_routes.ts";
import type { RouteConfig } from "../../core/src/types.ts";
